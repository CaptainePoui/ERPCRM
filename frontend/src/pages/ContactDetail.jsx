...
const PORTAL_PERM_GROUPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      ['can_manage_audio_prompts', "Gérer les messages audio / musique d'attente (téléverser, renommer, supprimer)"],
      ['can_listen_audio_prompts', 'Écouter les messages audio / musique d\'attente'],
      ['can_generate_voice_prompts', 'Générer une phrase par synthèse vocale (IA)'],
