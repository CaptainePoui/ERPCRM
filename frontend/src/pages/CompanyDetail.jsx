      ...
      <div className="detail-body">
        {isNew ? (
          ...
          <>
            ...
            {tab === 5 && (
              <>
                <CdrSection companyId={id} />
                <CdrReportsSection companyId={id} />
              </>
            )}
...
const CDR_WEEKDAY_LABELS = ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche']
const CDR_FREQUENCY_LABELS = { custom_days: 'Journalier (jours choisis)', weekly: 'Hebdomadaire', monthly: 'Mensuel' }
const CDR_DIRECTION_LABELS = { '': 'Tous les appels', inbound: 'Entrants seulement', outbound: 'Sortants seulement' }
...
function CdrReportsSection({ companyId }) {
  ...
  return (
    <div style={{ marginTop: 28 }}>
      ...
      {showModal && (
        <CdrReportModal companyId={companyId} report={editing} sipExts={sipExts} onClose={() => setShowModal(false)}
...
function CdrReportModal({ companyId, report, sipExts, onClose, onSaved }) {
