...
export default function NewDevisModal({ onClose, prefillCompany = null }) {
  ...
  const [form, setForm] = useState({ apply_tps: true, apply_tvq: true })
  ...
  async function save() {
    ...
    setSaving(true)
    try {
      const r = await api.post('/v1/devis', {
